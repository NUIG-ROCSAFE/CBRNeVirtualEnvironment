...
def main(no_ravs, no_cameras = 1, rav_velocity = 4, rav_altitude = 35, rav_route_write_dir = "", gps_coords_write_dir="", saved_images_dir=""):
	...
	rav_locs = base_dir + "/RCode/ShinyApp/Data/"
	...
	if not os.path.exists(base_dir + '/PythonCode/PythonClientGPSMapping/GPSMappings/Images'):
		os.makedirs(base_dir + '/PythonCode/PythonClientGPSMapping/GPSMappings/Images')

	for rav_no in range(int(no_ravs)):
		if not os.path.exists(base_dir + '/PythonCode/PythonClientGPSMapping/GPSMappings/Images/Images%d/' % (rav_no + 1)):
			os.makedirs(base_dir + '/PythonCode/PythonClientGPSMapping/GPSMappings/Images/Images%d/' % (rav_no + 1))
